...
function handleGalleryForm() {
    ...
    if ($_POST['media_source'] === 'local') {
        ...
        if (
            strpos($media_url, 'youtube') !== false || 
            strpos($media_url, 'youtu.be') !== false || 
            strpos($media_url, 'vimeo') !== false || 
            strpos($media_url, 'facebook') !== false || 
            strpos($media_url, 'tiktok') !== false
        ) {
...
<head>
  ...
  <style>
    ...
    .sidebar { min-height: 100vh; background: linear-gradient(135deg, #003366, #001f4d); color: white; }
    .sidebar .nav-link { color: rgba(255,255,255,0.8); border-radius: 5px; margin-bottom: 5px; }
    ...
    #mediaPreviewContent img { display: block; margin: auto; max-width: 100%; height: auto; max-height: 80vh; }
    #currentMediaPreview { margin-top: 15px; }
  </style>
</head>
<body>
