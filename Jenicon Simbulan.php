...
// -----------------------------------------------------------------------------
// HELPER FUNCTIONS (backend – unchanged)
// -----------------------------------------------------------------------------
...
// Section-specific handler functions (unchanged from your original code)
...
function handleGalleryForm() {
    ...
    if ($_POST['media_source'] === 'local') {
        ...
        if (strpos($media_url, 'youtube') !== false || strpos($media_url, 'youtu.be') !== false || strpos($media_url, 'vimeo') !== false) {
            $detected_type = "video_link";
        } else {
            $detected_type = "link";
        }
    }
          ...
          <div class="col-md-3 col-lg-2 sidebar p-0">
              <div class="p-4">
                  ...
                  <ul class="nav flex-column">
                      <li class="nav-item"><a class="nav-link <?php echo ($current_section=='awards')?'active':''; ?>" href="?section=awards"><i class="fas fa-trophy"></i> Awards</a></li>
                      <li class="nav-item"><a class="nav-link <?php echo ($current_section=='offices')?'active':''; ?>" href="?section=offices"><i class="fas fa-building"></i> Offices</a></li>
                      <li class="nav-item"><a class="nav-link <?php echo ($current_section=='services')?'active':''; ?>" href="?section=services"><i class="fas fa-concierge-bell"></i> Services</a></li>
                      <li class="nav-item"><a class="nav-link <?php echo ($current_section=='announcements')?'active':''; ?>" href="?section=announcements"><i class="fas fa-bullhorn"></i> Announcements</a></li>
                      <li class="nav-item"><a class="nav-link <?php echo ($current_section=='news')?'active':''; ?>" href="?section=news"><i class="fas fa-newspaper"></i> News</a></li>
                      <li class="nav-item"><a class="nav-link <?php echo ($current_section=='gallery')?'active':''; ?>" href="?section=gallery"><i class="fas fa-images"></i> Gallery</a></li>
                      <li class="nav-item"><a class="nav-link <?php echo ($current_section=='documents')?'active':''; ?>" href="?section=documents"><i class="fas fa-file-alt"></i> Documents</a></li>
                      <li class="nav-item"><a class="nav-link <?php echo ($current_section=='emergency')?'active':''; ?>" href="?section=emergency"><i class="fas fa-phone-alt"></i> Emergency</a></li>
                      <li class="nav-item"> <a class="nav-link" href="profile_settings.php"><i class="fas fa-user"></i> Profile Settings</a></li>
                                  ...
                                  <tr>
                                      <?php if ($current_section === 'awards'): ?>
                                          ...
                                          <td>
                                              ...
                                              <img src="<?php echo ltrim($item['award_image_url'], './'); ?>" class="img-thumbnail" alt="Award Image">
                                              <?php endif; ?>
                                          </td>
                                          <td>
                                              <span class="badge bg-<?php echo $item['award_status'] === 'active' ? 'success' : 'secondary'; ?>">
                                          ...
                                          <td>
                                              ...
                                              <a href="?section=awards&action=delete&id=<?php echo $item['award_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">
                                      ...
                                      <?php elseif ($current_section === 'offices'): ?>
                                          ...
                                          <td>
                                              ...
                                              <img src="<?php echo ltrim($item['office_image_url'], './'); ?>" class="img-thumbnail" alt="Office Image">
                                              <?php endif; ?>
                                          </td>
                                          <td><?php echo htmlspecialchars($item['office_link']); ?></td>
                                          <td>
                                              <span class="badge bg-<?php echo $item['office_status'] === 'active' ? 'success' : 'secondary'; ?>">
                                          ...
                                          <td>
                                              ...
                                              <a href="?section=offices&action=delete&id=<?php echo $item['office_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">
                                                  <i class="fas fa-trash"></i>
                                              </a>
                                              <button class="btn btn-sm btn-info view-btn" 
                                      ...
                                      <?php elseif ($current_section === 'services'): ?>
                                          ...
                                          <td>
                                              ...
                                              <img src="<?php echo ltrim($item['service_icon_url'], './'); ?>" class="img-thumbnail" alt="Service Icon">
                                              <?php endif; ?>
                                          </td>
                                          <td><?php echo htmlspecialchars($item['office_name']); ?></td>
                                          <td>
                                              <span class="badge bg-<?php echo $item['service_status'] === 'active' ? 'success' : 'secondary'; ?>">
                                          ...
                                          <td>
                                              ...
                                              <a href="?section=services&action=delete&id=<?php echo $item['service_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">
                                                  <i class="fas fa-trash"></i>
                                              </a>
                                              <button class="btn btn-sm btn-info view-btn" 
                                      ...
                                      <?php elseif ($current_section === 'announcements'): ?>
                                          ...
                                          <td>
                                              ...
                                              <img src="<?php echo ltrim($item['announcement_image_url'], './'); ?>" class="img-thumbnail" alt="Announcement Image">
                                              <?php endif; ?>
                                          </td>
                                          <td><?php echo date('M j, Y', strtotime($item['announcement_date'])); ?></td>
                                          <td>
                                              <span class="badge bg-<?php echo $item['announcement_status'] === 'published' ? 'success' : 'secondary'; ?>">
                                          ...
                                          <td>
                                              ...
                                              <a href="?section=announcements&action=delete&id=<?php echo $item['announcement_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">
                                                  <i class="fas fa-trash"></i>
                                              </a>
                                              <button class="btn btn-sm btn-info view-btn" 
                                      ...
                                      <?php elseif ($current_section === 'news'): ?>
                                          ...
                                          <td>
                                              ...
                                              <img src="<?php echo ltrim($item['news_image_url'], './'); ?>" class="img-thumbnail" alt="News Image">
                                              <?php endif; ?>
                                          </td>
                                          <td><?php echo date('M j, Y', strtotime($item['news_date'])); ?></td>
                                          <td>
                                              <span class="badge bg-<?php echo $item['news_status'] === 'published' ? 'success' : 'secondary'; ?>">
                                          ...
                                          <td>
                                              ...
                                              <a href="?section=news&action=delete&id=<?php echo $item['news_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">
                                                  <i class="fas fa-trash"></i>
                                              </a>
                                              <button class="btn btn-sm btn-info view-btn" 
                                      ...
                                      <?php elseif ($current_section === 'documents'): ?>
                                          ...
                                          <td>
                                              ...
                                              <a href="<?php echo ltrim($item['document_url'], './'); ?>" target="_blank">View Document</a>
                                              <?php endif; ?>
                                          </td>
                                          <td><?php echo pathinfo($item['document_url'], PATHINFO_EXTENSION); ?></td>
                                          <td>
                                              <span class="badge bg-<?php echo $item['document_status'] === 'active' ? 'success' : 'secondary'; ?>">
                                          ...
                                          <td>
                                              ...
                                              <a href="?section=documents&action=delete&id=<?php echo $item['document_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">
                                                  <i class="fas fa-trash"></i>
                                              </a>
                                          </td>
                                      <?php elseif ($current_section === 'emergency'): ?>
                                          ...
                                          <td>
                                              ...
                                              <img src="<?php echo ltrim($item['emergency_logo'], './'); ?>" class="img-thumbnail" alt="Emergency Logo">
                                              <?php endif; ?>
                                          </td>
                                          <td><?php echo htmlspecialchars($item['emergency_category']); ?></td>
                                          <td>
                                              <span class="badge bg-<?php echo $item['emergency_status'] === 'active' ? 'success' : 'secondary'; ?>">
                                          ...
                                          <td>
                                              ...
                                              <a href="?section=emergency&action=delete&id=<?php echo $item['emergency_id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure?')">
                                                  <i class="fas fa-trash"></i>
                                              </a>
                                              <button class="btn btn-sm btn-info view-btn" 
        ...
        <div class="modal-body">
          ...
          <?php elseif ($current_section === 'offices'): ?>
              ...
              <div class="mb-3">
                  ...
                  <input type="file" class="form-control" id="office_image" name="office_image" accept="image/*">
              </div>
              <div class="mb-3">
          ...
          <?php elseif ($current_section === 'services'): ?>
              ...
              <div class="mb-3">
                  ...
                  <input type="file" class="form-control" id="service_icon" name="service_icon" accept="image/*,svg">
              </div>
              <div class="mb-3">
          ...
          <?php elseif ($current_section === 'announcements'): ?>
              ...
              <div class="mb-3">
                  ...
                  <textarea class="form-control" id="announcement_content" name="announcement_content" required></textarea>
              </div>
              <div class="mb-3">
          ...
          <?php elseif ($current_section === 'gallery'): ?>
              ...
              <div class="mb-3" id="local_media_field">
                  ...
                  <input type="file" class="form-control" id="gallery_media" name="gallery_media" accept="image/*,video/*">
              </div>
              <div class="mb-3" id="media_link_field" style="display:none;">
                  <label for="media_link" class="form-label">Media Link</label>
                  <input type="url" class="form-control" id="media_link" name="media_link" placeholder="https://">
              </div>
              <div class="mb-3">
          ...
          <?php elseif ($current_section === 'emergency'): ?>
              ...
              <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="emergency_category" name="emergency_category" required>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                  ...
                  <input type="file" class="form-control" id="emergency_logo" name="emergency_logo" accept="image/*">
              </div>
              <div class="mb-3">
...
<script>
// Toggle media input fields for gallery based on source selection
...
// Reset modal form when "Add New" is clicked
document.getElementById('addNewBtn').addEventListener('click', function(){
    document.getElementById("crudForm").reset();
    <?php if ($current_section === 'awards'): ?>
      document.getElementById('award_id').value = "";
      document.getElementById('addModalLabel').textContent = "Add New Awards";
    <?php elseif ($current_section === 'offices'): ?>
...
// Handle "Edit" button clicks; populate the modal with existing data (file inputs remain blank).
document.querySelectorAll('.edit-btn').forEach(function(button){
    button.addEventListener('click', function(){
        ...
        if (section === 'awards') {
            ...
            // Clear media fields so that the existing file remains if no new input is given.
...
// Handle "View" button clicks so that images and videos (or links) open in a modal.
document.querySelectorAll('.view-btn').forEach(function(button){
    button.addEventListener('click', function(){
        ...
        if (mediaType === 'image') {
            content += '<img src="' + mediaContent + '" class="img-fluid mx-auto d-block" alt="Media">';
            ...
            var embedUrl = '';
            if(mediaContent.indexOf('youtube') !== -1 || mediaContent.indexOf('youtu.be') !== -1){
                var videoId = '';
                var regex = /(youtu\.be\/|v=)([^&]+)/;
                var match = mediaContent.match(regex);
                if(match){
                    videoId = match[2];
                    embedUrl = 'https://www.youtube.com/embed/' + videoId;
                }
            } else if(mediaContent.indexOf('vimeo') !== -1){
            ...
            if(embedUrl){
                content += '<iframe width="100%" height="400" src="' + embedUrl + '" frameborder="0" allowfullscreen></iframe>';
            } else {
                content += '<a href="' + mediaContent + '" target="_blank">Visit Video</a>';
            }
        } else if(mediaType === 'link'){
            content += '<a href="' + mediaContent + '" target="_blank" class="btn btn-primary">Visit Site</a>';
        }
